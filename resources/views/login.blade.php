...
<div class="max-w-md mx-auto bg-white p-8 shadow rounded">
    ...
    <form method="POST" action="{{ route('login.submit') }}" class="space-y-4">
        ...
        <div>
            ...
            <input type="text" name="cpf" id="cpf" maxlength="14" class="w-full border border-gray-300 p-2 rounded" required>
        </div>

        <div>
            <label for="senha" class="block text-sm font-medium">Senha</label>
            <div class="relative">
                <input type="password" name="senha" id="senha" class="w-full border border-gray-300 p-2 rounded pr-10" required>
